...
<head>
  ...
  <link rel="stylesheet" href="css/edit_area.css">
...
<div class="edit_area">
  <form id="article_area" name="article_area" method="post" action="upload_article.php"
        onsubmit="return check_article(this);">
